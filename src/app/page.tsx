...
import logoWag from '#/images/logos/wag.svg'
...
function SocialLink({ icon: Icon, ...props }) {
  return (
    <span className="group -m-1 p-1" {...props}>
...
export default async function Home() {
  ...
  return (
    <>
      <SimpleContainer className="mt-16 sm:mt-32 sm:px-8">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://github.com/sroussey"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/sroussey"
      ...
      <Photos />
      <SimpleContainer className="mt-24 md:mt-28">
